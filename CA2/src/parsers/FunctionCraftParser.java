// Generated from C:/Users/ALI/OneDrive/Desktop/university/Project/Compiler/FunctionCraft-Compiler/CA2/src/main/grammar/FunctionCraft.g4 by ANTLR 4.13.1
package parsers;
	...
	public final PatternMatchingContext patternMatching() throws RecognitionException {
		...
		try {
			...
			((PatternMatchingContext)_localctx).patternName = match(IDENTIFIER);
			        ...
			        Identifier id_pattern_ = new Identifier((((PatternMatchingContext)_localctx).patternName!=null?((PatternMatchingContext)_localctx).patternName.getText():null));
			        id_pattern_.setLine((((PatternMatchingContext)_localctx).patternName!=null?((PatternMatchingContext)_localctx).patternName.getLine():0));
			...
			match(RPAR);
			        ...
			        Identifier id_target_ = new Identifier((((PatternMatchingContext)_localctx).targetVar!=null?((PatternMatchingContext)_localctx).targetVar.getText():null));
			        id_target_.setLine((((PatternMatchingContext)_localctx).targetVar!=null?((PatternMatchingContext)_localctx).targetVar.getLine():0));
			        ((PatternMatchingContext)_localctx).patternRet =  new PatternDeclaration(id_pattern_, id_target_);
				...
				if ( _alt==1 ) {
					...
					((ExpressionContext)_localctx).e2 = eqaulityExpression();
					                  ...
					                  if ((((ExpressionContext)_localctx).e1.expRet instanceof AppendExpression)){
					                      AppendExpression e1_expRet = (AppendExpression) ((ExpressionContext)_localctx).e1.expRet;
