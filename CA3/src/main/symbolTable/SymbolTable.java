...
public class SymbolTable {
    ...
    private static Stack<ArrayList<Type>> returnTypesStack = new Stack<>();
    ...
    public static void addReturnType(Type type) {
        returnTypesStack.peek().add(type);
    }

    public static void pushReturnTypeStack() {
        returnTypesStack.push(new ArrayList<>());
    }

    public static ArrayList<Type> popReturnTypeStack() {
        return returnTypesStack.pop();
    }
